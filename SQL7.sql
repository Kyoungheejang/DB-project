-- 7. 최근 2년간 주최기관별 행사진행 횟수, 평균총예산 및 기관정보 조회

select	to_char(e_info.e_s_date, 'yyyy') "주최연도", 
...
where 	e_info.go_ck_code=204 and 
	e_info.e_s_date>=add_months(trunc(sysdate),-24) 
